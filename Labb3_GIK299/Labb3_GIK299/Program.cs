...
namespace Labb3_GIK299
{
    ...
    {
        public int MayDays { get; set; }
        public double DailyTemperatures { get; set; }
        public TemperatureInfo(int MayDays, double DaliyTemperatures)
            {
            this.MayDays = MayDays;
            this.DailyTemperatures = DaliyTemperatures;
            }
